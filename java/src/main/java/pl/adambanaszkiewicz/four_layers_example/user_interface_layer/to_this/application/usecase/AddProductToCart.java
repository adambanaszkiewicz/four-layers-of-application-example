package pl.adambanaszkiewicz.four_layers_example.user_interface_layer.to_this.application.usecase;

import pl.adambanaszkiewicz.four_layers_example.user_interface_layer.to_this.domain.CartRepositoryInterface;
import pl.adambanaszkiewicz.four_layers_example.user_interface_layer.to_this.domain.Cart;
import pl.adambanaszkiewicz.four_layers_example.user_interface_layer.to_this.domain.ProductDTO;
...
@Service("UserInterfaceLayerToThisAddProductToCart")
public class AddProductToCart {
    private final CartRepositoryInterface repository;

    @Autowired
    public AddProductToCart(
        @Qualifier("UserInterfaceLayerToThisCartRepository") CartRepositoryInterface repository
    ) {
        this.repository = repository;
    }

    public void execute(String productId, int qty, String userId) throws Exception {
        // Begin transaction
        try {
